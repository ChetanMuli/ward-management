...
function CitizenShell({children}){
 ...
 return <div className="user-portal">
  <header className="user-topbar">
   <div className="user-brand" onClick={()=>go('/')} role="button" tabIndex={0}><div className="user-brand-mark notranslate" translate="no"><BrandIcon size={32} variant="dark" /></div><div><strong className="notranslate" translate="no">WardDesk</strong><span>Your Ward · Digital Services</span></div></div>
