...
import {Empty,ErrorBox,Loading,PageHeader,SearchableSelect,StatusPill,Toolbar,fmtDate,Modal} from '../components/Ui';
...
function RecordDetails({item}){
 ...
 const groups={
  ...
  Family:{title:'Family information',fields:[['Family name',r.familyName],['House ID',r.houseId],['Native village',r.nativeVillage],['Taluka',r.nativeTaluka],['District',r.nativeDistrict],['State',r.nativeState],['Notes',r.notes]]},
  ...
  Shop:{title:'Shop / office information',fields:[['Name',r.name],['Type',r.kind],['Category',r.category],['Address',r.address],['Landmark',r.landmark],['Owner',r.ownerName],['Owner mobile',r.ownerMobile],['Ownership',r.ownership],['Notes',r.notes]]},
  ...
  NagarsevakSchedule:{title:'Daily schedule',fields:[['Title',r.title],['Date',r.scheduledDate],['Time',r.scheduledTime],['Location',r.location],['Category',r.category],['Priority',r.priority],['Status',r.status],['Notes',r.description]]},
