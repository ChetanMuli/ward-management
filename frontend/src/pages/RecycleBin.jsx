...
export default function RecycleBin(){
 ...
 return <div className="admin-data-page recycle-page">
  ...
  <section className="panel recycle-filter-panel"><div className="filter-panel-head"><div><span className="eyebrow">RECOVERABLE DATA</span><h3>Find deleted records</h3><p>Review complete record information before restoring.</p></div><span className="auto-filter-badge">● Auto updated</span></div><Toolbar><WardFilter/><SearchableSelect value={type} onChange={setType} options={[{value:'',label:'All types'},...['Person','Family','House','Shop','Ward','Area','Complaint','VoterProfile','GovernmentVoterList'].map(x=>({value:x,label:x==='Shop'?'Shop / Office':x}))]} placeholder="Search record type…"/></Toolbar></section>
