 ...
 return <div className="admin-dashboard-page">
  ...
  <section className="panel dashboard-info-panel">
   ...
   <div className="stat-grid">
    ...
    {can('VIEW_HOUSES')&&<StatCard label="Apartments" value={data.apartments||0} hint="Buildings with flats" onClick={()=>openTo('/houses')}/>}
