...
router.post('/wards/:wardId/areas',requirePermission('VIEW_WARDS'),wards.createArea);
router.patch('/areas/:id',requirePermission('VIEW_WARDS'),wards.updateArea);
router.delete('/areas/:id',requirePermission('VIEW_WARDS'),wards.removeArea);
router.get('/apartments',requirePermission('VIEW_WARDS'),wards.listApartments);
router.post('/apartments',requirePermission('VIEW_WARDS'),wards.createApartment);
router.patch('/apartments/:id',requirePermission('VIEW_WARDS'),wards.updateApartment);
router.delete('/apartments/:id',requirePermission('VIEW_WARDS'),wards.removeApartment);
...
router.get('/shops',requirePermission('VIEW_HOUSES'),shops.list);
router.post('/shops',requirePermission('CREATE_HOUSES'),shops.create);
router.get('/shops/:id',requirePermission('VIEW_HOUSES'),shops.detail);
router.patch('/shops/:id',requirePermission('EDIT_HOUSES'),shops.update);
router.delete('/shops/:id',requirePermission('DELETE_HOUSES'),shops.remove);
